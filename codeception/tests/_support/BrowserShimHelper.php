...
/**
 * Fusion of PhpBrowser and WebDriver functionality.
 *
 * @category  AcceptanceTests
 * @package   Fpc\Shop\Tests\Acceptance
 * @author    Sławomir Jabłeka <slawomir.jableka@codete.co>
...
class BrowserShimHelper extends Module implements  Remote, MultiSession
{
    ...
    const CONFIG_WD_HOST    = 'host';
    const CONFIG_WD_PORT    = 'port';
    ...
    const ENV_WD_HOST    = 'SHIM_WD_HOST';
    const ENV_WD_PORT    = 'SHIM_WD_PORT';
    ...
    public function __construct($config = null)
    {
        ...
        if ($this->isWebDriver()) {
            ...
            $this->setEnvOption($config[$this->moduleName], self::CONFIG_WD_HOST, self::ENV_WD_HOST);
            $this->setEnvOption($config[$this->moduleName], self::CONFIG_WD_PORT, self::ENV_WD_PORT);
